...
#           politician = Politician.find_by(normalized_name: p_name.delete(" "))
#           next if politician.nil?  # 見つからなければスキップ
...
#           politician = Politician.find_by(normalized_name: a_name.delete(" "))
